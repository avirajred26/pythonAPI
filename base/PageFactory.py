...
class PageFactory(object):
    ...
    def is_element_present(self, timeout=None):
        try:
            if timeout is None:
                timeout = PageFactory().timeout
                WebDriverWait(self.parent, timeout).until(EC.visibility_of(self))
...
WebElement.is_element_present = PageFactory.is_element_present
